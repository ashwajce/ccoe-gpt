# Embedding Model Options for CCOEGPT

This document compares embedding model formats and providers for semantic search in CCOEGPT.
...
embedding_cache_dir = "~/.cache/ccoegpt/models"
```
...
[memory]
embedding_provider = "gguf"
embedding_model = "~/.cache/ccoegpt/models/embeddinggemma-300M-Q8_0.gguf"
```
